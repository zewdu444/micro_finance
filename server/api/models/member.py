...
class Members(Base):
    ...
    created_user = relationship("Users", foreign_keys=[created_by], back_populates="members_created")
    updated_user = relationship("Users", foreign_keys=[updated_by], back_populates="members_updated")
    ...
    saving_applications = relationship("Saving_applications", back_populates="members")
